`timescale 1ns / 1ps
//////////////////////////////////////////////////////////////////////////////////
// Module for a 2nd order differential filter with a high-frequency roll-down and adjustable damping.
// It does not have timing margin at 100 MS/s; used here for the low sample-rate temperature servo PID's.
// Hard-coding values has timing margin with [1, 1.25, 1.5, 1.75] resolution for NF and NG.
//
...
module DBS#(parameter SIGNAL_SIZE = 25, FB = 32, OVB = 1)(
